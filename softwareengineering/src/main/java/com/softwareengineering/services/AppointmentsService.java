...
public class AppointmentsService {
    ...
    public static void setAppointment(int doctorID, int patientID, java.sql.Timestamp timeFrom,
            java.sql.Timestamp timeTo, java.sql.Timestamp date, Status status) {
