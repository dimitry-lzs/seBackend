...
public class AuthUtils {
     ...
     */
    public static int validateUserAndGetId(Context context, UserTypeEnum requiredUserType) throws UnauthorizedException {
        ...
        try {
            userType = UserTypeEnum.valueOf(userTypeStr);
